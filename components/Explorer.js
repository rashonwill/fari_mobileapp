                  ...
                  <View style={styles.movieCard}>
                    ...
                    <View className="controls" style={styles.controls}>
                      <View className="controls-two" style={styles.controlsTwo}>
                        ...
                        <Pressable style={{width: 70, height: 70, borderRadius: '50%', backgroundColor: 'green'}} onPress={() => {navigation.navigate('Creators'), console.log('clicking avi')}} >
                          <View
                            className="avi"
                            style={{
                              width: 65,
