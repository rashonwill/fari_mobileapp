                        ...
                        <View
                          ...
                          <View className="channel" style={styles.channel}>
                            <View
                              ...
                              <Image
                                source={{
                                  uri: channelUploads.profile_avatar ? channelUploads.profile_avatar : 'https://drotje36jteo8.cloudfront.net/noAvi.png'
                                }}
                                style={{
                                  width: 60,
                                  height: 60,
        ...
        <ScrollView>
          ...
          <View style={styles.statcard}>
            ...
            <Text
              ...
              TOTAL VIEWS: {`${viewsConversion(viewsTotal)}`}
            </Text>
          </View>
          <View style={styles.statcard}>
            ...
            <Text
              ...
              TOTAL COMMENTS: {`${viewsConversion(comments ? comments : '0')}`}
            </Text>
          </View>
          ...
          <View style={styles.statcard}>
            ...
            <Text
              ...
              TOTAL DISLIKES: {`${viewsConversion(dislikes)}`}
            </Text>
          </View>
          <View style={styles.statcard}>
            ...
            <Text
              ...
              TOTAL ITEMS SOLD: {`${viewsConversion(soldtotal)}`}
            </Text>
          </View>
        </ScrollView>
      </View>
                  ...
                  <View style={styles.profile}>
                    ...
                    <Text
                      style={{
                       ...
                       {`${viewsConversion(profile.subscriber_count)}`} Subscribers
                    </Text>
                  </View>
                </>
              );
          ...
          options={{
            ...
            {photo && photo.length > 0 ? photo.map((image) => {
                   return(
                      ...
                      source={{
                        uri: image.profile_avatar ? image.profile_avatar : 'https://drotje36jteo8.cloudfront.net/noAvi.png',
                      }}
                    />
