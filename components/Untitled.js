...
async function checkSubStatus(){
  ...
  try {
    const response = await fetch(`https://fari-testapi.herokuapp.com/api/users/substatus/${userSubed}/${channelid}`,{
      method: 'GET',  
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${TOKEN}`
...
console.error('Oops could not determine subscription status', error)
  ...
  var channelid = getChannel.channelid;
  var channel_avi = getChannel.profile_avatar; 
 ...
 try {
   ...
   var channelname = getChannel.channelname;
   const response = await fetch(`https://fari-testapi.herokuapp.com/api/users/subscribe/${channelname}`,{
       method: 'POST',  
       headers: {
         'Content-Type': 'application/json',
         'Authorization': `Bearer ${TOKEN}`
...
async function unsubscribe(){
 ...
 try {
   ...
   var channelname = getChannel.channelname;
   const response = await fetch(`https://fari-testapi.herokuapp.com/api/users/unsubscribe/${channelname}/${userSubed}`,{
       method: 'DELETE',  
       headers: {
         'Content-Type': 'application/json',
         'Authorization': `Bearer ${TOKEN}`
